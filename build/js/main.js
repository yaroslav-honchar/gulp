...
class Dropdown {
  constructor() {
    ...
    _defineProperty(this, "init", dropdown => {
      const {
        triggerSelector,
        listSelector,
        linkSelector,
    ...
    _defineProperty(this, "closeOnWindow", () => {
      const {
        close
      } = this;
      window.addEventListener('click', _ref2 => {
        let {
          target
        } = _ref2;
        const clickedElements = (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_0__.domItaration)(target);
    ...
    _defineProperty(this, "calcListPosution", () => {
      const {
        dropdowns,
        listSelector,
        topClass
    ...
    _defineProperty(this, "changeListPosution", () => {
      const {
        calcListPosution
      } = this;
      calcListPosution();
    ...
    _defineProperty(this, "open", dropdown => {
      const {
        openClass
      } = this;
    ...
    _defineProperty(this, "close", dropdown => {
      const {
        openClass
      } = this;
    ...
    _defineProperty(this, "choose", (dropdown, target) => {
      const {
        close,
    ...
    if (options.dropdownSelector) {
      ...
      this.triggerValueSelector = options.triggerValueSelector && options.triggerValueSelector;
      ...
      this.inputSelector = options.inputSelector ? options.inputSelector : 'input';
      this.on = {
        init: options.on && options.on.init ? options.on.init.bind(this.on) : null,
        open: options.on && options.on.open ? options.on.open.bind(this.on) : null,
        close: options.on && options.on.close ? options.on.close.bind(this.on) : null,
        choose: options.on && options.on.choose ? options.on.choose.bind(this.on) : null
      } || {};
      this.dropdowns.forEach(dropdown => {
        this.init(dropdown);
      });
...
class FormValidation {
  constructor() {
    let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _defineProperty(this, "init", form => {
      // Input listener
    ...
    _defineProperty(this, "inputHandle", input => {
    ...
    _defineProperty(this, "submitHandle", input => {
      const {
        setInvalidClass
      } = this;
      switch (input.dataset.validationType) {
    ...
    _defineProperty(this, "mailValidate", input => {
      if (!this.inputMail.validate) return input.value !== '';
      return this.inputMail.regExp.test(input.value);
    });
    _defineProperty(this, "checkboxValidate", input => input.checked);
    _defineProperty(this, "emptyInputValidate", input => input.value !== '');
    _defineProperty(this, "telValidate", input => {
      const {
        maxLength,
        value,
        minLength
    ...
    _defineProperty(this, "nameInputValidate", input => {
      if (this.inputName.trim) input.value = input.value.replace(this.inputName.regExp, '');
      return input.value !== '';
    });
    _defineProperty(this, "radioValidate", inputs => {
    ...
    _defineProperty(this, "fileValidate", input => {
      const {
        files,
        accept
      } = input;
    ...
    _defineProperty(this, "setInvalidClass", (element, bool) => {
      const {
        invalidClass,
        validClass
      } = this;
    ...
    _defineProperty(this, "numberValidate", input => {
      const {
        max,
        value,
        min
    ...
    if (options.formSelector) {
      ...
      this.inputName = {
        ...
        regExp: options.inputName && options.inputName.regExp !== undefined ? options.inputName.regExp : /[^a-z A-Z а-я А-я Ї ї І і ]/g
      };
      this.inputTel = {
...
class Modal {
  constructor() {
    ...
    _defineProperty(this, "showModal", e => {
      this.modal.forEach(modal => {
    ...
    _defineProperty(this, "closeModal", (modal, trigger) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "domItaration": () => (/* binding */ domItaration),
/* harmony export */   "getDomHeight": () => (/* binding */ getDomHeight),
/* harmony export */   "getNumbersFromString": () => (/* binding */ getNumbersFromString),
...
/* harmony import */ var _modules_form_validation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/form-validation */ "./src/js/modules/form-validation.js");
...
window.addEventListener('load', () => {
  // Modal init
  new _modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  // Dropdown init
  new _modules_dropdown__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  new _modules_form_validation__WEBPACK_IMPORTED_MODULE_2__["default"]({
